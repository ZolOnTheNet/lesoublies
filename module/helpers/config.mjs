...
LESOUBLIES.actions = {
  ...
  "deloger"   : { label : "Déloger un adversaire", cmp : "Corps à Corps;Force", typeAction : "L", difficultes : { type:"O", code : { "":"" } }, conditions : "", reaction : "-"},
  "desarmer"  : { label : "Désarmer un adversaire", cmp : "Mêlée", typeAction : "LA", difficultes : { type:"O", code : { "":"" } }, conditions : "", reaction : "-"},
  "detruire"  : { label : "Détruire", cmp : "Force;Mêlée;Tir", typeAction : "L", difficultes : { type:"O", code : { "":"" } }, conditions : "", reaction : "-"},
  "encourager": { label : "Encourager un allié", cmp : "", typeAction : "L", difficultes : { type:"O", code : { "":"" } }, conditions : "", reaction : "-"},
  "evaluer"   : { label : "Evaluer un adversaire", cmp : "Stratégie", typeAction : "L", difficultes : { type:"O", code : { "":"" } }, conditions : "", reaction : "-"},
  "feinter"   : { label : "Feinter", cmp : "Subterfuge", typeAction : "L", difficultes : { type:"O", code : { "":"" } }, conditions : "", reaction : "-"},
